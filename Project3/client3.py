...
key_code = 2                    #Key for this device
key_list = [1]                  #Known devices
client_port = 33400             #This is used to connect to this client
server_port = 33500
...
#Data for server
server_package = [key_code, key_list, latitude, longitude, client_port, device_IP]
